!function(t,e){"object"==typeof exports&&"object"==typeof module?module.exports=e():"function"==typeof define&&define.amd?define([],e):"object"==typeof exports?exports.ReactMagic=e():t.ReactMagic=e()}(this,function(){return function(t){function e(i){if(n[i])return n[i].exports;var r=n[i]={exports:{},id:i,loaded:!1};return t[i].call(r.exports,r,r.exports,e),r.loaded=!0,r.exports}var n={};return e.m=t,e.c=n,e.p="",e(0)}([function(t,e,n){/** @preserve
	 ...
	 *
	 */
"use strict";function i(t,e,n){var i,r=new XMLHttpRequest;return e?(r.open("post",t,!0),r.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),i=Object.keys(e).map(function(t){return encodeURIComponent(t)+"="+encodeURIComponent(e[t])}).join("&")):r.open("get",t+"?cachebust="+Date.now(),!0),r.setRequestHeader("X-Requested-With","XMLHttpRequest"),r.onreadystatechange=function(){4===r.readyState&&n(r.responseText,r)},r.send(i),r}function r(t){var e="/** @jsx React.DOM */ "+f.convert(t);try{return JSXTransformer.exec(e)}catch(n){throw new Error("Something bad happened when transforming HTML to JSX: "+n)}}function o(t){var e=r(t);React.render(e,document.body)}function s(t){t.target&&t.target.tagName&&"a"==t.target.tagName.toLowerCase()&&(history.pushState(null,null,t.target.href),u(),t.preventDefault())}function a(t){var e=c(t.target);history.pushState({formValues:e},null,t.target.action),u(),t.preventDefault()}function u(){document.title="Loading...",document.body.classList.add("react-loading"),i(window.location.href,history.state&&history.state.formValues,l)}function l(t,e){var n=e.getResponseHeader("Content-Type").split(";")[0],i=-1===g.indexOf(n)||e.status<200||e.status>299;if(i)return void window.location.reload();var r=d(t,"body"),s=d(t,"title");document.title=s,o(r),document.body.classList.remove("react-loading")}function c(t){for(var e={},n=t.getElementsByTagName("input"),i=0,r=n.length;r>i;i++){var o=n[i];("checkbox"!==o.type&&"radio"!==o.type||o.checked)&&(e[n[i].name]=n[i].value)}return e}function d(t,e){var n="<"+e,i="</"+e,r=t.indexOf(n),o=t.indexOf(">",r),s=t.lastIndexOf(i),a=t.slice(o+1,s);return a}function p(){f=new m({createClass:!1});var t=document.body.innerHTML;o(t),o(t),h()}function h(){document.body.addEventListener("click",s,!1),document.body.addEventListener("submit",a,!1),window.addEventListener("popstate",u,!1)}var f,m=n(1),g=["text/html","text/plain"];p()},function(t,e,n){/** @preserve
	 *  Copyright (c) 2014, Facebook, Inc.
	 *  All rights reserved.
	 *
	 *  This source code is licensed under the BSD-style license found in the
